    ...
    <bds-alert-actions>
      ...
      <bds-grid xxs="12" direction="column" gap="1">
        ...
        <bds-paper>
           ...
           <iframe src="https://takenet.github.io/blip-ds/iframe.html?args=&globals=backgrounds.grid:false;backgrounds.value:transparent&id=alert--system-alert&viewMode=story" title="alert blip-ds component"></iframe>
        </bds-paper>
      </bds-grid>
